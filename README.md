...
- Visual Studio 2015 (or the Visual C++ Build Tools 2015) They can be downloaded from Microsoft: ([Visual Studio](https://www.visualstudio.com/vs/community/), [Visual C++ Build Tools 2015](http://landinghub.visualstudio.com/visual-cpp-build-tools)
- Windows 10 SDK in order to build programs with ponyc. [SDK](https://developer.microsoft.com/en-us/windows/downloads/windows-10-sdk)).
